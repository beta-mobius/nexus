...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 3. 创建模块描述符测�?        testModuleDescriptor();
        
        // 4. 创建模块注册表和仓库
        testRegistryAndRepository();
        
        // 5. 测试模块加载（需要JAR文件�?        // testModuleLoading();
    ...
    private static void testRegistryAndRepository() {
        ...
        // 创建注册�?        ModuleRegistry registry = new SimpleModuleRegistry();
        ...
        System.out.println("仓库根目�? " + repository.getClass().getSimpleName());
        System.out.println("仓库初始化完�?);
    }
    ...
    private static void testModuleLoading() throws ModuleException {
        ...
        // 创建加载�?        ModuleLoader loader = new ModuleLoader(registry, repository);
